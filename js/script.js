...
function generateTags(){
  /* find all articles */
  const tagsArticles = document.querySelectorAll(optArticleSelector);
...
function tagClickHandler(event){
  ...
  const tagLinks = article.querySelectorAll('a.active[href^"#tag-"]');
...
//authors
  ...
  function authorClickHandler(event){
    ...
    /* find all tag links with class active */
    const authorLinks = article.querySelectorAll('a.active[href^"#author-"]');
    ...
    /* find all tag links with "href" attribute equal to the "href" constant */
    const authorHrefLink = document.querySelectorAll('a[href="' + href + '"]')
  ...
  function addClickListenersToAuthors(){
    ...
    for (let allAuthorsLink of allAuthorsLinks){
      ...
      /* add tagClickHandler as event listener for that link */
      allAuthorsLink.addEventListener('click', tagClickHandler);
